function EK_preprocessfMRI(datadir,t1FileName)
...
datadir = '/home/ekubota/Desktop/test2';
t1FileName = '/home/ekubota/Desktop/test2/t1_acpc.nii.gz';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EDIT THIS:
...
% cd(datadir)
% EPIs = dir('*EPI*.nii.gz');
% epifilenames = {EPIs(1).name, EPIs(2).name};
% cd(h)
% 

% what NIFTI files should we interpret as EPI runs?
epifilenames = matchfiles([datadir '/*EPI*.nii*'], 'tr');
